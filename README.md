...
| 이상혁 | Terraform IaC 구성, AWS FIS 기반 카오스 엔지니어링                          |
| 송원준 | Terraform IaC 구성, Amazon Q Developer-Slack 알림 파이프라인 구축          |
| 최민규 | 프론트엔드 개발, 백엔드 API 개발, k6 부하 테스트                                 |
| 김원호 | 프론트엔드 개발                                                        |
| 이유은 | Terraform IaC 구성, ArgoCD 기반 GitOps CI/CD 파이프라인 구축, k6 기반 부하 테스트 |
