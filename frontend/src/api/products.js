...
export async function createProduct(payload) {
    const request = {
        ...
        category: CATEGORY_TO_ENUM[payload.category] || payload.category || "ETC",
        defectReason: payload.defectReason || "ETC",
        originalPrice: payload.originalPriceValue,
        discountRate: payload.discountRate ?? payload.discount ?? 0,
        ...
        timedDiscountRate1: payload.timedDiscountRate1 || 0,
        timedDiscountRate2: payload.timedDiscountRate2 || 0,
...
export async function updateProduct(productId, updates) {
    const request = {
        ...
        category: updates.category ? (CATEGORY_TO_ENUM[updates.category] || updates.category || "ETC") : undefined,
        defectReason: updates.defectReason,
        originalPrice: updates.originalPriceValue,
        discountRate: updates.discountRate ?? updates.discount ?? 0,
        ...
        timedDiscountRate1: updates.timedDiscountRate1 || 0,
        timedDiscountRate2: updates.timedDiscountRate2 || 0,
